...
//#define PASTER(x,y,z) Java_org_## x ##_app_## y ## _ ## z
#define PASTER(x,y,z) Java_org_common_## y ## _ ## z
#define EVALUATOR(x,y,z)  PASTER(x,y,z)
#define __FUNC_NAME(__class, __arg) EVALUATOR(APP_NAME, __class, __arg)
...
/* Drop file */
void __FUNC_NAME(SDLActivity, onNativeDropFile)(
...
/* Resize */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeResize) (
                                    JNIEnv* env, jclass jcls,
...
/* Paddown */
JNIEXPORT jint JNICALL __FUNC_NAME(SDLActivity, onNativePadDown) (
                                    JNIEnv* env, jclass jcls,
...
/* Padup */
JNIEXPORT jint JNICALL __FUNC_NAME(SDLActivity, onNativePadUp) (
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeJoy) (
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeHat)(
                                    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL __FUNC_NAME(SDLActivity, nativeAddJoystick)(
    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL __FUNC_NAME(SDLActivity, nativeRemoveJoystick)(
...
/* Surface Created */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeSurfaceChanged)(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeSurfaceDestroyed)(JNIEnv* env, jclass jcls)
{
...
/* Keydown */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeKeyDown)(
...
/* Keyup */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeKeyUp)(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeKeyboardFocusLost)(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeTouch)(
                                    JNIEnv* env, jclass jcls,
...
/* Mouse */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeMouse)(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, onNativeAccel)(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, nativeLowMemory)(
...
/* Quit */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, nativeQuit)(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, nativePause)(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
JNIEXPORT void JNICALL __FUNC_NAME(SDLActivity, nativeResume)(
                                    JNIEnv* env, jclass cls)
{
...
JNIEXPORT void JNICALL __FUNC_NAME(SDLInputConnection, nativeCommitText)(
                                    JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL __FUNC_NAME(SDLInputConnection, nativeSetComposingText)(
                                    JNIEnv* env, jclass cls,
                                    jstring text, jint newCursorPosition)
{
    const char *utftext = (*env)->GetStringUTFChars(env, text, NULL);
...
JNIEXPORT jstring JNICALL __FUNC_NAME(SDLActivity, nativeGetHint)(JNIEnv* env, jclass cls, jstring name) {
...
static int Internal_Android_JNI_FileOpen(SDL_RWops* ctx)
{
    ...
    if (!LocalReferenceHolder_Init(&refs, mEnv)) {
		LOGE("LocalReferenceHolder_Init failed");
        goto failure;
    }
    ...
    */
    ...
    if (Android_JNI_ExceptionOccurred(SDL_TRUE)) {
		LOGE("Android_JNI_ExceptionOccurred calling openFd");
        goto fallback;
    }
    ...
    if (Android_JNI_ExceptionOccurred(SDL_TRUE)) {
		LOGE("Android_JNI_ExceptionOccurred calling getStartOffset");
        goto fallback;
    }
    ...
    if (Android_JNI_ExceptionOccurred(SDL_TRUE)) {
		LOGE("Android_JNI_ExceptionOccurred calling getDeclaredLength");
        goto fallback;
    }
