...
extern DECLSPEC void SDLCALL WINRT_ProcessCharacterReceivedEvent(Windows::UI::Core::CharacterReceivedEventArgs ^args);
extern DECLSPEC void SDLCALL WINRT_ProcessCharacterReceivedEventRawKeyCode(int rawKeyCode);

extern DECLSPEC void SDLCALL WINRT_ProcessKeyUpEventRouted(Windows::UI::Xaml::Input::KeyRoutedEventArgs ^args);
extern DECLSPEC void SDLCALL WINRT_ProcessKeyDownEventRouted(Windows::UI::Xaml::Input::KeyRoutedEventArgs ^args);
