...
extern int gzdecompress(const void *src, int srcLen, void *dst, int dstLen);

// main
extern int numpreviewplayers;
extern bool Main_Start(int argc, char **argv);
extern void Main_LoopOnce();
