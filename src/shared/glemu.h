namespace gle
{
    ...
    static inline void color(const bvec &v) { glVertexAttrib4f(ATTRIB_COLOR, (float)v.x/255, (float)v.y/255, (float)v.z/255, 1.0); }
    static inline void color(const bvec &v, float blend) { glVertexAttrib4f(ATTRIB_COLOR, (float)v.x/255, (float)v.y/255, (float)v.z/255, blend/255); }
    static inline void colorub(const uchar &a, const uchar &b, const uchar &c) { color(bvec(a, b, c)); }
    static inline void colorub(const uchar &a, const uchar &b, const uchar &c, const uchar &d) { color(bvec(a, b, c), d); }
