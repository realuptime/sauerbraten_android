...
class FileIO;
extern FileIO *getlogfile();
extern FileIO *logfile;
extern void writelog(FileIO *file, const char *buf);
extern void writelogv(FileIO *file, const char *fmt, va_list args);
